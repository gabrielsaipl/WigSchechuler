...
{
    public partial class HorizontalFullYearCalendar
    {
        /* variables and properties */

        // Popup variables for external component parameters
        ...
        //method to create the calendar (days and months)
        private void GenerateCalendar()
        {
            ...
            {
                var month = new Month();
                daysInMonth = DateTime.DaysInMonth(_currentMonth.Year, i);
        ...
        private void DayClicked(ResourceData resourse, int dayNumber, int MonthNumber)
        {
